<x-app-layout>
    <div class="flex-1 overflow-y-auto bg-zinc-950 px-8 py-8">
        ...
        <div class="max-w-6xl mx-auto mt-4">
            @if(session('cart_purged'))
            <div class="flex items-start gap-3 mb-5 p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-5 text-orange-400 mt-0.5 shrink-0">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                </svg>
                <p class="text-sm text-orange-300">{{ session('cart_purged') }}</p>
            </div>
            @endif

            {{-- Error notice (e.g. tried to add a disabled model) --}}
            @if(session('error'))
            <div class="flex items-start gap-3 mb-5 p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-5 text-red-400 mt-0.5 shrink-0">
