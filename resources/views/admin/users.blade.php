<x-admin-layout>
    <main class="min-h-screen p-8 lg:p-12">
        ...
        <header class="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div class="space-y-2">
                <span class="font-label text-xs font-bold text-secondary uppercase tracking-[0.3em]">Directory
                    Management</span>
                <h2 class="text-4xl font-headline font-bold text-on-surface tracking-tight">Manage Users</h2>
                <p class="text-on-surface-variant max-w-lg">Monitor user activity, manage permissions, and review
                    transaction history for the Kinetic Gallery ecosystem.</p>
            </div>
            <div class="flex items-center gap-4">
                <div
                    class="bg-surface-container-low px-4 py-2 flex items-center gap-3 group focus-within:ring-1 ring-primary transition-all">
                    <span class="material-symbols-outlined text-outline" data-icon="search">search</span>
                    <input class="bg-transparent border-none focus:ring-0 text-sm w-64 placeholder:text-outline"
                        placeholder="Search by name or email..." type="text" />
                </div>
                <button
                    class="bg-surface-container-high p-2 text-on-surface hover:bg-surface-container-highest transition-colors">
                    <span class="material-symbols-outlined" data-icon="filter_list">filter_list</span>
                </button>
            </div>
        </header>
        <!-- Bento Grid Layout for User Stats & List -->
        <div class="grid grid-cols-12 gap-8">
            <!-- User List Column -->
            <div class="col-span-12 lg:col-span-8 space-y-4">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="font-headline text-lg font-bold">Registered Members <span
                            class="text-outline font-normal ml-2">1,248 total</span></h3>
                </div>
                <!-- User Table/List -->
                <div class="space-y-3">
                    <!-- User Row 1 (Active) -->
                    <div
                        ...
                        <div class="text-right flex items-center gap-8">
                            ...
                            <span
                                class="material-symbols-outlined text-outline group-hover:text-on-surface transition-colors"
