                            ...
                            <tr class="hover:bg-zinc-800/40 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center flex-shrink-0">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @else
                                            <span class="px-3 py-1.5 text-xs text-zinc-600 italic">You</span>
                                        @endif
                                    </div>
                                </td>
                            </tr>
