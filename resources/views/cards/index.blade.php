<x-app-layout>
    <div class="flex-1 overflow-y-auto w-full">
        <div class="max-w-4xl mx-auto px-6 py-10 space-y-10">
            ...
            @if(session('success'))
                <div
                    class="flex items-center gap-3 px-4 py-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-emerald-400 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <section class="space-y-4">
                ...
                @if($cards->count())
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @foreach($cards as $card)
                                    ...
                                    @endphp
                                    <div
                                        class="relative bg-gradient-to-br {{ $gradient }} border border-white/10 rounded-2xl p-6 overflow-hidden">
                ...
                @else
                    <div
                        class="flex flex-col items-center justify-center py-16 bg-zinc-900 border border-zinc-800/60 rounded-2xl text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                ...
                <form action="{{ route('cards.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex items-start gap-3 px-4 py-3 bg-cyan-500/5 border border-cyan-500/20 rounded-lg">
                        ...
                        <p class="text-xs text-cyan-400/80">
                            Solo guardamos los últimos 4 dígitos de tu tarjeta. Nunca almacenamos el número completo ni
                            el CVV. Las compras son simuladas.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="card_brand" name="card_brand"
                                ...
                                <option value="mastercard" {{ old('card_brand') === 'mastercard' ? 'selected' : '' }}>
                                    Mastercard</option>
                                <option value="amex" {{ old('card_brand') === 'amex' ? 'selected' : '' }}>American Express
                                </option>
