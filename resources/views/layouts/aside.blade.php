...
<aside class="h-screen fixed top-0 left-0 w-64 bg-zinc-900 border-r border-zinc-800/50 flex flex-col py-6 z-50">
    ...
    <div class="px-4 mt-4 mb-4">
        <a href="{{ route('admin.models.create') }}">
            <button class="w-full py-2.5 bg-cyan-500 hover:bg-cyan-400 text-black font-bold rounded-lg flex items-center justify-center gap-2 text-sm transition-all active:scale-95">
