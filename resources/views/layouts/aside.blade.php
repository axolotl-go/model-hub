<aside class="h-full realtive top-0 left-0 w-64 bg-zinc-900 border-r border-zinc-800/50 flex flex-col py-6 z-50">
    <div class="px-6 mb-8">
    ...
    <div class="border-t border-zinc-800/50 pt-4">
        ...
        <a class="flex items-center gap-3 px-4 py-3 text-zinc-500 hover:text-red-500 transition-all" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
